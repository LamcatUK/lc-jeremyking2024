...
function acf_blocks()
{
    if (function_exists('acf_register_block_type')) {
        ...
        acf_register_block_type(array(
            ...
            'category'			=> 'layout',
            'icon'				=> 'cover-image',
            'render_template'	=> 'page-templates/blocks/lc_hero_carousel.php',
            'mode'	=> 'edit',
            'supports' => array('mode' => false),
        ));
        acf_register_block_type(array(
        ...
        acf_register_block_type(array(
            'name'				=> 'lc_three_icon_cards',
            'title'				=> __('LC Icon Cards'),
            'category'			=> 'layout',
            'icon'				=> 'cover-image',
            'render_template'	=> 'page-templates/blocks/lc_three_icon_cards.php',
            'mode'	=> 'edit',
            'supports' => array('mode' => false),
        ));
        acf_register_block_type(array(
            ...
            'category'			=> 'layout',
            'icon'				=> 'cover-image',
            'render_template'	=> 'page-templates/blocks/lc_vimeo.php',
            'mode'	=> 'edit',
            'supports' => array('mode' => false),
        ));
        acf_register_block_type(array(
            'name'				=> 'lc_file_download',
            'title'				=> __('LC File Download'),
            'category'			=> 'layout',
            'icon'				=> 'cover-image',
            'render_template'	=> 'page-templates/blocks/lc_file_download.php',
            'mode'	=> 'edit',
            'supports' => array('mode' => false),
        ));
    }
