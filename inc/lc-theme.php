...
function widgets_init()
{
    // register_sidebar(
    //     array(
    //         'name'          => __('Footer Col 1', 'lc-jeremyking2024'),
    //         'id'            => 'footer-1',
    //         'description'   => __('Footer Col 1', 'lc-jeremyking2024'),
    ...
    register_nav_menus(array(
        'primary_nav' => __('Primary Nav', 'lc-jeremyking2024'),
        'footer_menu1' => __('Footer Menu 1', 'lc-jeremyking2024'),
        'footer_menu2' => __('Footer Menu 2', 'lc-jeremyking2024'),
    ));
